    ...
    public static class Config
    {
        ...
        public static class AdquiraPage
        {
            ...
            public static class FaturaInternaForm
            {
                ...
                public static string TipoDocumentoSAP = "KN - Depósitos Judiciais";
                ...
                public static string FormaPagamento = "Deposito";
                ...
                public static string DataVencimento = DateTime.Now.AddMonths(3).ToString("dd/MM/yyyy");
                ...
                public static string CPFCNPJFavorecido = "111.111.111-11";
        ...
        public static class VivoPagtoPage
        {
            ...
            public static class FaturaInternaForm
            {
                public static string[] lstFileUpload = new string[]
                {
                    @"C:\Users\andre\Documents\SoldPagamento.pdf",
                    @"C:\Users\andre\Documents\SoldPagamento.pdf",
                    @"C:\Users\andre\Documents\SoldPagamento.pdf"
                };
