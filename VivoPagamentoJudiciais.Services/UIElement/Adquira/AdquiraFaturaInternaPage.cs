...
namespace VivoPagamentoJudiciais.Services.UIElement.Adquira
{
    public class AdquiraFaturaInternaPage
    {
        ...
        public IWebElement fieldAreaReclamacao => Driver.driver.FindElement(By.Id("gwt-uid-100"));
        public IWebElement fieldTipoNotaFiscalAnaliseTributaria => Driver.driver.FindElement(By.Id("gwt-uid-102"));
        ...
        public IWebElement fieldTipoPagamento => Driver.driver.FindElement(By.Id("gwt-uid-110"));
